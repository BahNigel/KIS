...
const handleFilePicker = async ({selectedFiles, projectForm, setSelectedFiles, setProjectForm}:handleFilePickerProps) => {
    try {
      ...
      setProjectForm({ ...projectForm, media: updatedFiles });
    } catch (error) {
  ...
  export const handleRemoveFile = ({uri, selectedFiles, projectForm, setSelectedFiles, setProjectForm}:handleRemoveFileProps) => {
    const updatedFiles = selectedFiles.filter((file) => file.uri !== uri);
    setSelectedFiles(updatedFiles);
    setProjectForm({ ...projectForm, media: updatedFiles });
  };

  export const handleMediaTypeChange = ({type, setMediaType, setProjectForm, projectForm, setMediaLink}:handleMediaTypeChangeProps) => {
    setMediaType(type);
